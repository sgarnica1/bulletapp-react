...
function AddWodForm() {
      ...
      <div className="AddWodForm__input-grid">
        ...
        <Input
          ...
          validationHandler={(values) => {
            console.log(values);
            // if (parseInt(values.reps) === 0 || values.reps === "0") return false;
            // if (parseInt(values.sets) === 0 || values.sets === "0") return false;
            return true;
          }}
  ...
  function handleSubmitData(event) {
    ...
    console.log(rounds, validRounds)

    // // TODO - Add validation to the form
    // if (!validDate) return setSubmitError(true);
    // if (!validWodTitle) return setSubmitError(true);
    // if (!validDescription) return setSubmitError(true);
    // if (!validTimeCap) return setSubmitError(true);
    // if (!validRounds) return setSubmitError(true);
