...
// COMPONENTS
import { AddRecordFormHeader } from "./AddRecordFormHeader";
...
const AddRecordForm = ({ recordType, closeModal }) => {
  const { user } = useAuth();
  ...
  useEffect(() => {
    if (closeModal) setSubmitError(false);
    if (closeModal || currentRecordCategory === "") {
    ...
    if (!movements) {
      ...
      // actionsMov.getMovements();
    }
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [currentRecordCategory, closeModal]);
  ...
  return (
    <div className="AddRecordForm">
      ...
      >
        ...
        {/* <ErrorInput errorMessage={submitError} show={submitError} /> */}
