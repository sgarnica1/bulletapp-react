...
const BulletGoalWidget = () => {
  ...
  if (wod && wod !== -1) {
    return (
      <article className="BulletGoalWidget">
        <h1 className="BulletGoalWidget__title">Reto Bullet</h1>
        <div className="BulletGoalWidget__date">
          <p>{utils.getMonthYear()}</p>
        </div>
        <p className="BulletGoalWidget__description">Max Burpees (5 min)</p>

        <form
          action=""
          className="BulletGoalWidget__form"
        ...
        {error && (
          <div className="BulletGoalWidget__error">
            <p className="BulletGoalWidget__error__text">
